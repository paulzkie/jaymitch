...
$(document).ready(function (e) {
 ...
 $("#sliderform").on('submit',(function(e) {
  ...
  $.ajax({
   url: base_url+"index.php/slider/do_upload",
   type: "POST",
...
$(document).on('click', '.delete', function(){
    if(confirm("Are you sure you want to deleted this?")==true){
            $.ajax({
                type: "POST",
                url: base_url+"index.php/slider/remove",
                data: {sliderid: $(this).data("sliderid"),},
                success: function(data){
                    var message = JSON.parse(data);
                    if(message.stat==1){
                        alert(message.msg);
...
$("#sliderid").val($(this).data("sliderid"));
                ...
                <div class="col-lg-12">
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            <div class="form">
                                <form class="cmxform form-horizontal " id="sliderform" method="post" enctype="multipart/form-data">
        ...
        <?php foreach($userdata as $data){ ?>
          <tr data-expanded="true">
            ...
            alt="<?php echo $data->name;?>"></td>
                ...
                data-sliderid="<?php echo $data->sliderid?>"
                data-name="<?php echo $data->name?>"
                data-desc="<?php echo $data->description?>">Update</button><td>
                <button class="btn-warning delete" data-sliderid="<?php echo $data->sliderid?>" type="submit">Delete</button>    
                </td></td>
          </tr>
           <?php } ?>
        </tbody>
