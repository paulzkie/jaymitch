...
$(document).ready(function (e) {
 ...
 $("#newsform").on('submit',(function(e) {
  ...
  $.ajax({
   url: base_url+"index.php/news/do_upload",
   type: "POST",
   ...
   success: function(data){
            ...
            if(message.stat==1){
                alert(message.msg);
                $("#datacontainer").load(base_url+"index.php/news #datalist");
...
$(document).on('click', '.delete', function(){
    if(confirm("Are you sure you want to deleted this?")==true){
            $.ajax({
                type: "POST",
                url: base_url+"index.php/news/remove",
                ...
                <div class="col-lg-12">
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            <div class="form">
                                <form class="cmxform form-horizontal " id="newsform" method="post" enctype="multipart/form-data">
        ...
        <?php foreach($userdata as $data){ ?>
          <tr data-expanded="true">
            ...
            alt="<?php echo $data->title;?>"></td>
                ...
                <button class="btn-warning delete" data-newsid="<?php echo $data->newsid?>" type="submit">Delete</button>    
                </td></td>
          </tr>
           <?php } ?>
        </tbody>
