...
$(document).on('click', '#save', function(e){
          $.ajax({
                type: "POST",
                url: base_url+"index.php/payments/updates",
...
<div id="myModal1" class="modal">
  ...
  <div class="modal-content">
    <div class="modal-header">
      ...
      <center><h2>Update Bank/ Remittance</h2></center>
    </div>
    <section class="panel">
                        ...
                        <div class="panel-body" style="width: 700px;">
                            <div class="form">
                                <form class="cmxform form-horizontal " id="updatebank" method="post">
                                    <div class="form-group ">
                                        <label for="time" class="control-label col-lg-3">Bank/ Remittance:</label>
                                        <div class="col-lg-6">
                                            <input class=" form-control" name="bank" id="bank" type="text">
                                        </div>
                                    </div>
