...
if($("#cat").val()==""){
     alert('Select category of this menu.');
          ...
          $.ajax({
           url: base_url+"index.php/menu/do_upload",
           type: "POST",
...
$(document).on('click', '.delete', function(){
    if(confirm("Are you sure you want to deleted this?")==true){
            $.ajax({
                type: "POST",
                url: base_url+"index.php/menu/remove",
...
$("#dishname").val($(this).data("dishname"));
                ...
                <div class="col-lg-12">
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            <div class="form">
                                <form class="cmxform form-horizontal " id="menuform" method="post" enctype="multipart/form-data">
                                    <div class="form-group ">
                                        <label for="name" class="control-label col-lg-3">Dish Name</label>
                                        <div class="col-lg-6">
                                            <input class=" form-control" name="dishname" type="text">
                                        </div>
                                    </div>
                                    <div class="form-group ">
                                    ...
                                    <div class="form-group ">
                                        ...
                                        <div class="col-lg-6">
                                            <input class=" form-control" name="price" type="text" onkeypress="return isNumberKey(event)">
                                        </div>
                                    </div>
                                    <div class="form-group ">
        ...
        <?php foreach($getMenu as $menu){ ?>
          <tr data-expanded="true">
            ...
            alt="<?php echo $menu->dishname;?>"></td>
                ...
                data-price="<?php echo $menu->price?>">Update</button><td>
                <button class="btn-warning delete" data-menuid="<?php echo $menu->menuid?>" type="submit">Delete</button>    
                </td>
          </tr>
           <?php } ?>
        </tbody>
